...
// skybox shader simulating day night transition
// It accepts a cube map texture for day, another for night and finally a texture for color gradient
...
void main()
{
   ...
   // finalColor = vec4(textureCube(environmentMapDay,  rot*fragPosition).rgb, 1.0);
}
